...
//  echo false;
echo '<div class="alert alert-danger" style="border-radius:3px;text-align:center;background-color:#E23D28;color:#fff;padding:10px 85px;margin-top:0px">Your account is being verified, check back again later</div>';
}else{
    $_SESSION['id']=$row['id'];
