...
-->
                ...
                <a id="forgotNowBtn" style="cursor:pointer" onclick="openModal('forgot-modal')">Forgot your password?
                    Click here.</a>
...
-->
                ...
                <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin-top: 40px;text-align:center ">Already have
                    an Account? <a id="loginNowBtn" style="text-decoration: underline;margin-left: 5px;"><b>Login
                            Here</b></a></div>
...
---->
                ...
                <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin-top: 40px;display: flex;justify-content: center; ">
                    <button class="btn btn--blue register-btn" style="text-decoration:none" id="forgot_submit1">
        ...
        <div class="modal-general forgot-modal2">
            ...
            <form method="post" name="forgotform" id="forgot_password2" target="forgotpass">
                ...
                <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin-top: 40px;display: flex;justify-content: center; ">
                    <button class="btn btn--blue register-btn" style="text-decoration:none" id="forgot_submit2">
...
-->
            ...
            <form method="post" id="withdrawal_form">
                ...
                ?>
                        <div class="input-holder-byicon">
                            ...
                            <label for="country" style="margin-left:10px;color:#000">Make sure your wallet address is
                                correct:</label><br>
                        </div><br>
                        <div class="input-holder-byicon">
                        ...
                        <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin: 40px auto !important;text-align: center;display: flex;justify-content: center; ">
                            <button class="btn btn--blue register-btn" style="text-decoration:none" id="withdrawal_submit">
        ...
        <div class="modal-general count_down-modal" bis_skin_checked="1" style="display: none;">
            ...
            <form method="post" id="withdrawal_form">
                ...
                <h5 style="text-align:center;">Deposit funds(0.045+ BTC) to your account now, and enjoy extra benefit:
                    <span style="color:#A38A00">$200 Bonus</span>
                </h5>
                <br>
                ...
                <!--                <h3 id="tester"><?php if (isset($_SESSION['id'])) {
                                                    ...
                                                    ?></h3>-->
                <h2 style="text-align:center;"><span style="background-color:#808080;padding:6px;border-radius:3.5px;" id="count_hour">24</span> : <span style="background-color:#808080;padding:6px;border-radius:3.5px;" id="count_min">00</span> :
                    <span style="background-color:#808080;padding:6px;border-radius:3.5px;" id="count_sec">00</span>
                </h2>
                ...
                <br><br>
                <h5 style="text-align:center;">Simply click the "Deposit" or "Make A Deposit", follow the instructions
                    and get your account funded. The minimum amount to deposit is equal to 0.001BTC and there is no fees
                    on deposits</h5>
            </form>
        ...
        <div class="modal-general deposit_modal2" bis_skin_checked="1" style="display: none;">
            ...
            <form method="post" id="deposit_form2">
                ...
                <h4 style="text-align:left;">Please pay exactly the above stated <span class="paynow_currency"></span>
                    amount to this address: </h4>
                <h4 class="paynow_wallet" style="overflow-wrap: break-word;width: 95% !important;padding:10px;background-color:#DCDCDC;border-radius:3px"></h4>
                <br><br>
                ...
                <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin: 10px auto !important;text-align: center;display: flex;justify-content: center; ">
                    <a class="btn btn--blue register-btn" style="text-decoration:none" id="hashcode_button">
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (json.error != "ok") {
                                    ...
                                    var message =
                                        '<div class="alert alert-success" style="border-radius:3px;text-align:center;background-color:green;color:#fff;padding:10px 85px;margin-top:0px">Hashcode Sent <br> Hashcode will be verified ASAP</div>';
                                    $(".pay_now_message").html(message);
        ...
        <div class="modal-general buy_mining_modal1" bis_skin_checked="1" style="display: none;">
            ...
            <form method="post" id="mining_form1">
                ...
                <div class="input-holder-byicon">
                    <label for="de_amount" style="margin-left:10px;color:#696969">Amount($):</label><br>
                    <input type="text" name="minin_amount" id="minin_amount" value='0' style="font-size: 14px;" autofocus placeholder="Amount" readonly>
                </div><br>
                <div class="input-holder-byicon">
                    <label for="plan" style="margin-left:10px;color:#A8A8A8">Select Cryptocurrency:</label><br>
                    <select id="buy_currency" class="plan_select" name="buy_currency" style="height:60px !important;width:inherit !important;font-size:13px !important;padding:0px 15px !important;margin-right:0px !important;border-radius:4px;">
                        <option value="">Select Cryptocurrency</option>
                        <option value="BTC">BTC</option>
                        <option value="ETH">ETH</option>
                    </select>
                ...
                <div class="input-holder-byicon">
                    ...
                    <input type="text" id="buy_name" value='' style="font-size: 14px;" autofocus placeholder="Name">
                </div><br>
                <div class="input-holder-byicon">
                    ...
                    <input type="text" id="buy_email" value='' style="font-size: 14px;" autofocus placeholder="E-mail">
                </div><br>
                <div class="input-holder-byicon">
                    <label for="de_email" style="margin-left:10px;color:#696969">Enter Your Address</label><br>
                    <input type="text" id="buy_address" value='' style="font-size: 14px;" autofocus placeholder="Address">
                </div>
                ...
                <div class="account-modal-bottom mn1_message" style="padding: 0 !important; position: relative; margin: 40px auto !important;text-align: center;display: flex;justify-content: center; ">
                </div>
        ...
        <div class="modal-general buy_mining_modal2" bis_skin_checked="1" style="display: none;">
            ...
            <form method="post" id="mining_form2">
                ...
                <div class="input-holder-byicon">
                    <label for="de_amount" style="margin-left:10px;color:#696969;text-align:center;">Amount(<span class="buynow_currency"></span>):</label><br>
                    <h2 style="margin-left:10px;"><span id="buy_btc_value">0.0988488</span> <span class="buynow_currency"></span></h2>
                </div>

                <h4 style="text-align:left;">Please pay exactly the above stated <span class="buynow_currency"></span>
                    amount to this address: <br><br><span class="buynow_wallet" style="padding:10px;background-color:#DCDCDC;border-radius:3px"></span></h4>
                <br><br>
                <input type="hidden" id="buy_last_id" value="">
                <h3 style="text-align:center;">Paid?</h3>
                <div class="input-holder-byicon">
                    <label for="de_email" style="margin-left:10px;color:#696969">Enter Transaction Hashcode:</label><br>
                    <input type="text" name="hashcode" id="buy_hashcode" value='' style="font-size: 14px;" autofocus placeholder="Hashcode">
                </div><br>
                <div class="account-modal-bottom" style="padding: 0 !important; position: relative; margin: 10px auto !important;text-align: center;display: flex;justify-content: center; ">
                ...
                <div class="account-modal-bottom buy_now_message" style="padding: 0 !important; position: relative; margin: 40px auto !important;text-align: center;display: flex;justify-content: center; ">
                </div>
