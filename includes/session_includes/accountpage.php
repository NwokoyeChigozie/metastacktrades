      ...
      <div class="make-invest" style="border-radius: initial!important;background-color: initial!important;box-shadow:initial!important;">
        ...
        <div class="make-invest__bottom">
          ...
          <div class="select-plan"> <input type="hidden" class="plantyper" value="1">
            ...
            <label for="plan-1" class="select-plan-item col-xl-6 col-lg-6 col-md-12 col-sm-12" style="margin-bottom: 10px;"> <b>300.00%</b> Profit <span>In 3 Day(s)</span>
            ...
            <label for="plan-2" class="select-plan-item col-xl-6 col-lg-6 col-md-12 col-sm-12" style="margin-bottom: 10px;"> <b>300.00%</b> Profit <span>In 5 Day(s)</span>
            ...
            <label for="plan-3" class="select-plan-item col-xl-6 col-lg-6 col-md-12 col-sm-12" style="margin-bottom: 10px;"> <b>300.00%</b> Profit <span>In 10 Day(s)</span>
            ...
            <label for="plan-4" class="select-plan-item col-xl-6 col-lg-6 col-md-12 col-sm-12" style="margin-bottom: 10px;"> <b>300.00%</b> Profit daily <span>In 20 Day(s)</span>
            </label>
          </div>
          <div class="float-profit-svg dashboard">
            ...
            <div> <strong id="lblProfit">10</strong><b>%</b>
              <span id="lblProfitType">Profit</span>
            </div> <small id="lblProfitPeriod" style="position:relative;">In 3 Days</small>
          </div>
          <div class="profit-calc">
            <div class="profit-calc__item"> <strong id="lblSelectedPlan">10%</strong> <span>Trading Plan</span>
            </div>
            <div class="profit-calc__item"> <strong id="lblDailyProfit">9.19</strong><strong> USD</strong> <span>Profit</span>
            </div>
            <div class="profit-calc__item"> <strong id="lblTotalProfit">10.28</strong><strong> USD</strong> <span>Total Profit</span>
            </div>
            <div class="profit-calc__item"> <strong id="lblTotalReturn">110.28</strong><strong> USD</strong> <span> Total Return</span>
            </div>
          </div>
  ...
  <div class="invest-rate" bis_skin_checked="1">
    <div class="invest-rate__left" bis_skin_checked="1">
      <div class="invest-rate__title" bis_skin_checked="1">
        ...
        </svg> <strong>$<?php echo  normalize_amount($total_deposit); ?> USD</strong> Total Investment
      </div>
...
-->
    ...
    <div bis_skin_checked="1">
      <div class="invest-rate__title" bis_skin_checked="1">
        ...
        </svg> <strong>$<?php echo  normalize_amount($total_withdrawal); ?> USD</strong> Total Withdrawals
      </div>
      <div class="invest-rate__detail" bis_skin_checked="1">
        <ul>
